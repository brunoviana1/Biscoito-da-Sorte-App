...
function App(){
  ...
  const[textoFrase, setTextoFrase] = useState('teste frase');
  ...
  return(
      <View style={styles.container} >
        ...
        <TouchableOpacity style={styles.botaoQuebrar} onPress={ quebraBiscoito }  >
        ...
        <TouchableOpacity style={[styles.botaoQuebrar, styles. botaoReiniciar ]} onPress={ reiniciarBiscoito}  >
          <View  style={styles.btnArea} >
            <Text style={[styles.btntexto, styles.btnTextReiniciar]}  > Reiniciar Biscoito </Text>
          </View>
        </TouchableOpacity>
